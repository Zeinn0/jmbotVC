...
from jmbot.helpers import _jmthonutils, fileinfo
from jmbot.helpers.functions import get_ytthumb, yt_search
...
class CatVC:
    ...
    async def leave_vc(self):
        ...
        await _jmthonutils.runcmd("rm -rf temp")
        self.clear_vars()
        ...
        **kwargs,
        ...
        if reply:
            ...
            try:
                ...
                url = input
                img = (
                    "https://github.com/Tgjmbot/CatVCPlayer/raw/beta/resources/404.png"
                )
            ...
            if path.exists():
                ...
                if kwargs:
                    ...
                    img = "https://github.com/Tgjmbot/CatVCPlayer/raw/beta/resources/404.png"
